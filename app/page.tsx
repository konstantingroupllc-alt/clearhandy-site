              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <a href="mailto:info@clearhandy.com" className="text-muted-foreground hover:text-primary transition-colors text-sm">info@clearhandy.com</a>
                  </div>
                </div>
                <div className="flex items-start gap-3">
            ...
            <Card className="p-5 md:p-6">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <Field>
                  ...
                  <Input id="phone" type="tel" placeholder="(555) 123-4567" value={formData.phone} onChange={(e) => setFormData({ ...formData, phone: e.target.value })} required />
                </Field>
                <Field>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-primary-foreground/80">
                ...
                <li className="flex items-center gap-2"><Mail className="h-4 w-4" /><a href="mailto:info@clearhandy.com" className="hover:text-primary-foreground">info@clearhandy.com</a></li>
