    ...
    <div className="min-h-screen">
      ...
      <div className="hidden lg:block">
        <div className="relative overflow-visible">
          ...
          <div className="absolute inset-0 w-full" style={{height: 'calc(100% + 160px)'}}>
            <img src="/hero-bg.png" alt="" className="w-full h-full object-cover object-[center_30%]" />
          </div>
          <div className="absolute inset-0 w-full pointer-events-none" style={{height: 'calc(100% + 160px)',
